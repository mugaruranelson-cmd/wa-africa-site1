...
export default function Ecommerce() {
    ...
    const problems = [
        "Order confirmations are sent manually — and delays lead to cancelled orders",
        "Stock availability questions fill your inbox every morning before your team is even online",
        "Payment follow-ups for COD orders require individual chasing — many are never collected",
        "Abandoned carts and incomplete orders go unaddressed because there is no follow-up system",
        "You have a large customer database but no reliable way to run broadcast campaigns",
        "Upsell and cross-sell opportunities are missed because every conversation is reactive"
    ];

    const solutions = [
        "Order confirmation flows — automatic confirmation sent the moment an order is placed",
        "Stock availability bot — instant responses to product and availability queries",
        "Payment reminder sequences — COD collections followed up at exactly the right time",
        "Cart recovery automation — re-engage customers who started but did not complete orders",
        "Post-purchase upsell flows — recommend complementary products after delivery",
        "Broadcast marketing campaigns — reach your full customer list with targeted offers"
    ];
        ...
        <div className="industry-page" style={{ paddingTop: 'calc(var(--space-24) + var(--space-8))' }}>
            ...
            <section className="section" style={{
                ...
                <div style={{
                    ...
                    inset: 0,
                    zIndex: -2,
                    backgroundImage: 'url("https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&q=80&w=2000")',
                ...
                <div className="container" style={{ maxWidth: '800px', position: 'relative', zIndex: 1 }}>
                    <div className="badge flex-center gap-2" style={{ marginBottom: 'var(--space-6)', background: 'rgba(255,255,255,0.1)', color: 'white', border: '1px solid rgba(255,255,255,0.2)', backdropFilter: 'blur(10px)', display: 'inline-flex' }}>
                        <ShoppingBag size={16} /> INDUSTRY PAGE — E-COMMERCE & RETAIL
                    </div>

                    <h1 className="animate-slide-up delay-100" style={{ marginBottom: 'var(--space-6)', color: 'white', fontSize: '3.5rem', lineHeight: 1.1 }}>
                        Turn WhatsApp Into Your
                        <br />
                        <span style={{ color: 'var(--color-green-light)' }}>E-commerce Growth Engine</span>
                    </h1>
                    ...
                    <p className="animate-slide-up delay-200" style={{ fontSize: '1.25rem', marginBottom: 'var(--space-10)', color: 'rgba(255,255,255,0.85)', lineHeight: 1.6 }}>
                        East African e-commerce runs on WhatsApp. Order inquiries, stock availability, payment follow-ups, COD verification, delivery updates — your customers expect to handle all of it on chat. The question is whether your team is doing it manually, or whether a system is doing it for you.
                    </p>
                    ...
                    <div className="animate-slide-up delay-300" style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                        <Link to="/strategy-call" className="btn btn-primary" style={{ padding: '1rem 2rem', fontSize: '1.125rem' }}>
                            Book a Free E-commerce Automation Call
                        </Link>
                    </div>
                </div>
            </section>
                ...
                <div className="container" style={{ maxWidth: '700px', textAlign: 'center' }}>
                    <div style={{
                        ...
                        <p style={{ fontSize: '1.25rem', color: 'var(--color-ink)', margin: 0, fontWeight: 500, lineHeight: 1.6 }}>
                            E-commerce automation projects typically start from $1,500. Exact investment depends on daily order volume, product catalogue complexity and campaign requirements.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="section" style={{ background: '#075E54', color: 'white', textAlign: 'center' }}>
                <div className="container" style={{ maxWidth: '700px' }}>
                    <h2 style={{ fontSize: '2.5rem', marginBottom: 'var(--space-4)', color: 'white' }}>Ready to Scale Your Store?</h2>
                    ...
                    <Link to="/strategy-call" className="btn btn-primary" style={{ padding: '1rem 2.5rem', fontSize: '1.125rem' }}>
                        Book Your Free E-commerce Automation Call <ArrowRight style={{ marginLeft: 8 }} size={20} />
                    </Link>
                </div>
            </section>
